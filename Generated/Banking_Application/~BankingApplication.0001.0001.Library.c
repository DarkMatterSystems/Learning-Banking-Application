    ...
    void)
{
    ...
    while (ent_customer != NULL) {
        ...
        if (
            ent_customer->rel_governed_by_bank_policy_head != 
            ent_customer->rel_governed_by_bank_policy_tail) {
    ...
    while (ent_account != NULL) {
        ...
        if (
            ent_account->rel_owned_by_customer_head != 
            ent_account->rel_owned_by_customer_tail) {
