...
typedef adm_base_integer_typ adm_int_account_number_typ;

typedef adm_base_fixed_typ   adm_fxd_money_typ;

typedef adm_base_string_typ  adm_str_name_typ;
typedef adm_base_string_typ  adm_str_location_typ;
